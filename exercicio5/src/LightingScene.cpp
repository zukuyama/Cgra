...
void LightingScene::init() 
{
	...
	clockAppearance = new CGFappearance(ambtableAppearance,diftableAppearance,spectableAppearance,shininesstableAppearance);
...
void LightingScene::display() 
{
	...
	/**
	 * TODO: !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!Edit clock code here!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	*/
	glPushMatrix();
		glTranslated(8, 8, 0.2);
		glScaled(2, 2, 0.1);
